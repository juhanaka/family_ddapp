...
SPECIAL_DICT = set(['brother','sister','sibling'])
...
for row in sys.stdin:
  ...
  # Get a sentence from ddlib -- array of "Word" objects
    ...
    # for i,word in enumerate(words_between.elements):
    #     if word in SPECIAL_DICT:
    #         ners_after = ners[p_start+p_length+i:c_start]
    #         if 'PERSON' in ners_after:
    #             features.add('other_person_after_keyword')
